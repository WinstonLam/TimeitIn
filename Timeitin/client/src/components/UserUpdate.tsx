...
const Form = () => {
  ...
  useEffect(() => {
    const selectedUser = user.find((user: any) => user._id === userId)
    if (selectedUser) {
      setFormValues({
  ...
  const validate = () => {
    const date = formValues.birthdate;
  ...
  const translatedColor = () => {
    return (
      formValues['color'] && (`rgba(${formValues.color.r}, ${formValues.color.g}, ${formValues.color.b}, ${formValues.color.a})`));
  };
